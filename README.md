...
- `build/openrouter-audio/openrouter-audio.sh`
...
```bash
build/openrouter-audio/openrouter-audio.sh transcribe <audio_file> [--format FORMAT] [--model MODEL] [--prompt PROMPT]
```
...
```bash
build/openrouter-audio/openrouter-audio.sh transcribe ./samples/meeting.mp3 --prompt "Summarize key decisions" --model openrouter/auto
```

### Generate

```bash
build/openrouter-audio/openrouter-audio.sh generate <text> [--voice VOICE] [--format FORMAT] [--model MODEL] [--prompt PROMPT] [--out PATH] [--dry-run]
```
...
build/openrouter-audio/openrouter-audio.sh generate "Test" --dry-run
```
...
npm run build
build/openrouter-audio/openrouter-audio.sh --help
build/openrouter-audio/openrouter-audio.sh generate "smoke" --dry-run
```
